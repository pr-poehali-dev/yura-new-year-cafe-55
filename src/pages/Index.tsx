...
const menuItems = {
  ...
  'Коктейли': [
    { name: 'Молочный коктейль', description: 'Нежный и воздушный', price: 'Бесплатно', emoji: '🥛' },
    { name: 'Шоколадный коктейль', description: 'С какао и сливками', price: 'Бесплатно', emoji: '🍫' },
    { name: 'Банановый коктейль', description: 'Свежий банан и молоко', price: 'Бесплатно', emoji: '🍌' },
  ],
  'Салаты': [
  ...
  'Кофе': [
    ...
    { name: 'Латте', description: 'Нежный с молоком', price: 'Бесплатно', emoji: '🥛' },
    { name: 'Капучино', description: 'С воздушной пенкой', price: 'Бесплатно', emoji: '☕' },
    { name: 'Американо', description: 'Мягкий и ароматный', price: 'Бесплатно', emoji: '☕' },
  ],
  'Мороженое': [
